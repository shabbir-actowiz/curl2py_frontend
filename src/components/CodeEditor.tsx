...
const defineCurlCraftTheme: BeforeMount = (monaco) => {
  ...
  monaco.editor.defineTheme("curlcraft-dark", {
    ...
    colors: {
      ...
      "editor.foreground": "#e3e7ea",
      "editorLineNumber.foreground": "#6d7480",
      "editorLineNumber.activeForeground": "#98e36c",
      "editorCursor.foreground": "#98e36c",
      "editor.selectionBackground": "#5f8f453d",
      "editor.inactiveSelectionBackground": "#2b334055",
      "editor.lineHighlightBackground": "#151a21",
      "editorBracketMatch.background": "#5f8f4538",
      "editorBracketMatch.border": "#98e36c66",
      "editorIndentGuide.background1": "#27303a",
      "editorIndentGuide.activeBackground1": "#4a5661",
      "editor.findMatchBackground": "#8a6f324d",
      "editor.findMatchHighlightBackground": "#8a6f322e",
      "scrollbarSlider.background": "#3b465566",
      "scrollbarSlider.hoverBackground": "#56627288",
    },
    rules: [
